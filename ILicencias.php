...
//Las variables, constantes y arreglos llevan un "$"
    ...
    $FechaVencimiento =date("Y-m-d", strtotime($FechaExp."+".$Vigencia." year"));
...
//Las variables, constantes y arreglos llevan un "$"
    ...
    $Manejador = fopen("Licencia".$NumLicencia.".xml", "w");
    ...
    C.Domicilio, C.GrupoSanguineo, C.Donador, C.Antiguedad, C.Firma, C.Foto
    ...
    $pdf->SetFont('Arial','B',4); 
    $pdf->SetXY(2,57);
    $pdf->Cell(0,3,utf8_decode('Fecha de Expedición'),0,1);
    $pdf->SetFont('Arial','',8); 
    $pdf->SetXY(2,60);
    ...
    $pdf->Output('D', "Licencia".$NumLicencia.".pdf"); 
    ...
    //Mover los archivos
$currentLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\\Licencia'.$NumLicencia.".pdf";
$newLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\Documentos\Licencias\\Licencia'.$NumLicencia.".pdf";
$moved = rename($currentLocation, $newLocation);

$currentLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\\Licencia'.$NumLicencia.".xml";
$newLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\Documentos\Licencias\\Licencia'.$NumLicencia.".xml";
$moved = rename($currentLocation, $newLocation);
