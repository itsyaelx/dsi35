<?php
    ...
    $Manejador = fopen("Vehiculo".$IdVehiculo.".xml", "w");
    ...
    $pdf->Output('D', "Vehiculo".$IdVehiculo.".pdf");


    //Mover archivos
    $currentLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\\Vehiculo'.$IdVehiculo.".pdf";
    $newLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\Documentos\Vehiculos\\Vehiculo'.$IdVehiculo.".pdf";
    $moved = rename($currentLocation, $newLocation);

    $currentLocation = 'C:\xampp\htdocs\Proyecto Final\dsi35\\Vehiculo'.$IdVehiculo.".xml";
